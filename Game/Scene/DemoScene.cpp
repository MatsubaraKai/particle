...
void DemoScene::Init()
{
	...
	levelDataLoader_->Initialize("Resources", "data.json");

	ObjModelData_ = model_[0]->LoadObjFile("project/gamedata/resources/block", "block.obj");
	ObjTexture_ = TextureManager::StoreTexture(ObjModelData_.material.textureFilePath);
}
...
void DemoScene::Update()
{
	...
	for (Object3d& object3d : levelEditorObjects_) {
		object3d.world.UpdateMatrix();
	}
...
void DemoScene::Draw()
{
	...
	for (Object3d& object3d : levelEditorObjects_) {
		object3d.model.Draw(textureHandle, material, DirectionalLight());
	}
}
